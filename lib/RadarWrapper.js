...
function getOffsets(e) {
  var offsetDict = {}
  console.log(e)
  // offsetDict['x'] = (e.offsetX || e.pageX - $(e.target).offset().left);
  // offsetDict['y'] = (e.offsetY || e.pageY - $(e.target).offset().top);
  offsetDict['x'] = e.pageX - $(e.target).offset().left;
  offsetDict['y'] = e.pageY - $(e.target).offset().top;
